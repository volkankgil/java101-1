...
public class diziilkders {
    ...
    public static void main(String[] args) {
        ...
        int [] list =new int[10]; //10 sayýsý dizinin boyutunu gösteriyor.veri tipi int yerine double veya string'te olabilir.
        int list2[]=new int[20]; //2. kullanýmý
        int [] list3={10,20,30,40,50,60}; //3. kullanýmý
        /*double [] list ;
        list = new double[20];
        4. kullanýmm þekli*/
        ...
        list[1]=20;
        list[2]=30;
        list[2]=45;//list 2 'de yeni deðer atamasý yaptým.
        ...
        int[]yeni=new int[10]; //ifadeyi 10,20,30 þeklinde yapacaðýz.
